...
#        else:
        ...
        if os.path.isfile(os.path.join(self.project_directory, self.xtalID, '2fofc_twin.map')):
            ...
            if os.path.isfile(os.path.join(self.project_directory, self.xtalID, self.mtz_style)):
                ...
                coot.auto_read_make_and_draw_maps(os.path.join(self.project_directory, self.xtalID, 'init_twin.mtz'))
            elif os.path.isfile(os.path.join(self.project_directory, self.xtalID, 'dimple_twin.mtz')):
                coot.auto_read_make_and_draw_maps(os.path.join(self.project_directory, self.xtalID, 'dimple_twin.mtz'))
