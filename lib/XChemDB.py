    ...
    def __init__(self, data_source_file):
        ...
        self.column_list = [
            ...
            ['CompoundSMILES',                       'Smiles',
                'TEXT',                 1],
            ['CompoundSMILESproduct',                'Smiles - Product',
                'TEXT',                 1],
            ['CompoundCode',                         'Compound ID',
                'TEXT',                 1],
            ['CompoundStereo',                       'Compound Stereo',
                'TEXT',                 1],
            ['CompoundStereoSMILES',                 'Stereo SMILES',
                'TEXT',                 1],
            ['CompoundStereoCIFprogram',             'Stereo CIF program',
                'TEXT',                 1],
            ['CompoundStereoCIFs',                   'Compound Stereo IDs',
                'TEXT',                 1],
            ['CompoundAutofitCC',                    'autofit CC',
                'TEXT',                 1],
            ['CompoundAutofitprogram',               'autofit program',
                'TEXT',                 1],
            ...
            ['CrystalFormC',                         'c',
                'TEXT',                 0],
            ['CrystalFormAlpha',                     'alpha',
                'TEXT',                 0],
            ['CrystalFormBeta',                      'beta',
                'TEXT',                 0],
            ['CrystalFormGamma',                     'gamma',
                'TEXT',                 0],
            ...
            ['DataCollectionRun',                    'Run',
                'TEXT',                 0],
            ['DataCollectionSubdir',                 'SubDir',
                'TEXT',                 0],
            ['DataCollectionComment',                'DataCollection\nComment',
                'TEXT',                 0],
            ['DataCollectionWavelength',             'Wavelength',
                'TEXT',                 0],
            ...
            ['DataProcessingUnitCell',               'DataProcessing\nUnitCell',
                'TEXT',                 0],
            ['DataProcessingAutoAssigned',           'auto-assigned',
                'TEXT',                 0],
            ...
            ['DataProcessingPathToLogfile',
                'DataProcessingPathToLogfile',                  'TEXT',                 1],
            ['DataProcessingPathToMTZfile',
                'DataProcessingPathToMTZfile',                  'TEXT',                 1],
            ['DataProcessingLOGfileName',                   'DataProcessingLOGfileName',
                'TEXT',                 0],
            ['DataProcessingMTZfileName',                   'DataProcessingMTZfileName',
                'TEXT',                 0],
            ['DataProcessingDirectoryOriginal',
                'DataProcessingDirectoryOriginal',              'TEXT',                 0],
            ...
            ['DataProcessingPathToDimplePDBfile',
                'DataProcessingPathToDimplePDBfile',            'TEXT',                 0],
            ['DataProcessingPathToDimpleMTZfile',
                'DataProcessingPathToDimpleMTZfile',            'TEXT',                 0],
            ['DataProcessingDimpleSuccessful',
                'DataProcessingDimpleSuccessful',               'TEXT',                 0],
            ...
            ['DataProcessingDimpleTwinSuccessful',
                'DataProcessingDimpleTwinSuccessful',           'TEXT',                 0],
            ...
            ['DatePanDDAModelCreated',                      'DatePanDDAModelCreated',
                'TEXT',                 0],

            ['RefinementResolution',                        'Refinement\nResolution',
                'TEXT',                 1],
            ['RefinementResolutionTL',                      'RefinementResolutionTL',
                'TEXT',                 0],
            ['RefinementRcryst',                            'Refinement\nRcryst',
                'TEXT',                 1],
            ['RefinementRcrystTraficLight',
                'RefinementRcrystTraficLight',                  'TEXT',                 0],
            ['RefinementRfree',                             'Refinement\nRfree',
                'TEXT',                 1],
            ['RefinementRfreeTraficLight',
                'RefinementRfreeTraficLight',                   'TEXT',                 0],
            ['RefinementSpaceGroup',                        'Refinement\nSpace Group',
                'TEXT',                 1],
            ['RefinementLigandCC',                          'Ligand CC',
                'TEXT',                 0],
            ['RefinementRmsdBonds',                         'RefinementRmsdBonds',
                'TEXT',                 1],
            ['RefinementRmsdBondsTL',                       'RefinementRmsdBondsTL',
                'TEXT',                 0],
            ['RefinementRmsdAngles',                        'RefinementRmsdAngles',
                'TEXT',                 1],
            ['RefinementRmsdAnglesTL',                      'RefinementRmsdAnglesTL',
                'TEXT',                 0],
            ['RefinementOutcome',                           'Refinement\nOutcome',
                'TEXT',                 1],
            ['RefinementOutcomePerson',                     'RefinementOutcomePerson',
                'TEXT',                 1],
            ['RefinementOutcomeDate',                       'RefinementOutcomeDate',
                'TEXT',                 1],

            ['RefinementMTZfree',                           'RefinementMTZfree',
                'TEXT',                 1],
            ['RefinementTwinMTZfree',                       'RefinementTwinMTZfree',
                'TEXT',                 1],
            ...
            ['RefinementCIFStatus',                         'Compound\nStatus',
                'TEXT',                 1],
            ['RefinementCIFprogram',                        'RefinementCIFprogram',
                'TEXT',                 1],
            ...
            ['RefinementMMCIFmodel_latest',
                'RefinementMMCIFmodel_latest',                  'TEXT',                 1],
            ['RefinementMMCIFreflections_latest',
                'RefinementMMCIFreflections_latest',            'TEXT',                 1],

            ['RefinementMatrixWeight',                      'RefinementMatrixWeight',
                'TEXT',                 0],
            ['RefinementComment',                           'RefinementComment',
                'TEXT',                 0],
            ['RefinementPathToRefinementFolder',
                'RefinementPathToRefinementFolder',             'TEXT',                 0],
            ['RefinementLigandConfidence',                  'Ligand\nConfidence',
                'TEXT',                 0],
            ['RefinementLigandBoundConformation',
                'RefinementLigandBoundConformation',            'TEXT',                 0],
            ['RefinementBoundConformation',
                'RefinementBoundConformation',                  'TEXT',                 0],
            ['RefinementMolProbityScore',                   'MolProbity Score',
                'TEXT',                 1],
            ['RefinementMolProbityScoreTL',
                'RefinementMolProbityScoreTL',                  'TEXT',                 0],
            ['RefinementRamachandranOutliers',              'Ramachandran\nOutliers',
                'TEXT',                 1],
            ['RefinementRamachandranOutliersTL',
                'RefinementRamachandranOutliersTL',             'TEXT',                 0],
            ['RefinementRamachandranFavored',               'Ramachandran\nFavored',
                'TEXT',                 1],
            ['RefinementRamachandranFavoredTL',
                'RefinementRamachandranFavoredTL',              'TEXT',                 0],
            ['RefinementProgram',                           'RefinementProgram',
                'TEXT',                 1],
            ['RefinementStatus',                            'Refinement\nStatus',
                'TEXT',                 1],
            ['RefinementBusterReportHTML',                  'buster-reports',
                'TEXT',                 1],
            ['RefinementRefiner',                           'RefinementRefiner',
                'TEXT',                 1],
            ['RefinementDate',                              'RefinementDate',
                'TEXT',                 1],


            ['Deposition_PDB_ID',                           'Deposition_PDB_ID',
                'TEXT',                 1],
            ['Deposition_PDB_file',                         'Deposition_PDB_file',
                'TEXT',                 0],
            ['Deposition_Date',                             'Deposition_Date',
                'TEXT',                 1],
            ['Deposition_mmCIF_model_file',
                'Deposition_mmCIF_model_file',                  'TEXT',                 0],
            ['Deposition_mmCIF_SF_file',                    'Deposition_mmCIF_SF_file',
                'TEXT',                 0],
        ...
        self.pandda_table_columns = [
            ...
            ['PANDDApath',
                'PANDDApath',                               'TEXT'],
            ['PANDDA_site_index',
                'PANDDA_site_index',                        'TEXT'],
            ['PANDDA_site_name',
                'PANDDA_site_name',                         'TEXT'],
            ['PANDDA_site_comment',
                'PANDDA_site_comment',                      'TEXT'],
            ['PANDDA_site_event_index',
                'PANDDA_site_event_index',                  'TEXT'],
            ['PANDDA_site_event_comment',
                'PANDDA_site_event_comment',                'TEXT'],
            ['PANDDA_site_confidence',
                'PANDDA_site_confidence',                   'TEXT'],
            ['PANDDA_site_InspectConfidence',
                'PANDDA_site_InspectConfidence',            'TEXT'],
            ['PANDDA_site_ligand_placed',
                'PANDDA_site_ligand_placed',                'TEXT'],
            ['PANDDA_site_viewed',
                'PANDDA_site_viewed',                       'TEXT'],
            ['PANDDA_site_interesting',
                'PANDDA_site_interesting',                  'TEXT'],
            ['PANDDA_site_z_peak',
                'PANDDA_site_z_peak',                       'TEXT'],
            ['PANDDA_site_x',
                'PANDDA_site_x',                            'TEXT'],
            ['PANDDA_site_y',
                'PANDDA_site_y',                            'TEXT'],
            ...
            ['PANDDA_site_ligand_id',
                'PANDDA_site_ligand_id',                    'TEXT'],

            ['PANDDA_site_ligand_resname',
                'PANDDA_site_ligand_resname',               'TEXT'],
            ['PANDDA_site_ligand_chain',
                'PANDDA_site_ligand_chain',                 'TEXT'],
            ['PANDDA_site_ligand_sequence_number',
                'PANDDA_site_ligand_sequence_number',       'TEXT'],
            ['PANDDA_site_ligand_altLoc',
                'PANDDA_site_ligand_altLoc',                'TEXT'],

            ['PANDDA_site_event_map',
                'PANDDA_site_event_map',                    'TEXT'],
            ['PANDDA_site_event_map_mtz',
                'PANDDA_site_event_map_mtz',                'TEXT'],
            ['PANDDA_site_initial_model',
                'PANDDA_site_initial_model',                'TEXT'],
            ['PANDDA_site_initial_mtz',
                'PANDDA_site_initial_mtz',                  'TEXT'],
            ['PANDDA_site_spider_plot',
                'PANDDA_site_spider_plot',                  'TEXT'],
            ['PANDDA_site_occupancy',
                'PANDDA_site_occupancy',                    'TEXT'],
            ['PANDDA_site_B_average',
                'PANDDA_site_B_average',                    'TEXT'],
            ['PANDDA_site_B_ratio_residue_surroundings',
                'PANDDA_site_B_ratio_residue_surroundings', 'TEXT'],
            ['PANDDA_site_RSCC',
                'PANDDA_site_RSCC',                         'TEXT'],
            ['PANDDA_site_RSR',
                'PANDDA_site_RSR',                          'TEXT'],
            ['PANDDA_site_RSZD',
                'PANDDA_site_RSZD',                         'TEXT'],
            ['PANDDA_site_rmsd',
                'PANDDA_site_rmsd',                         'TEXT'],
            ['RefinementOutcome',
                'RefinementOutcome',                        'TEXT'],
            ['ApoStructures',
                'ApoStructures',                            'TEXT'],
            ['LastUpdated',
                'LastUpdated',                              'TEXT'],
        ...
        self.deposition_table_columns = [
            ...
            ['DimplePANDDApath',
                'DimplePANDDApath',                         'TEXT'],

            ['contact_author_PI_salutation',
                'contact_author_PI_salutation',             'TEXT'],
            ['contact_author_PI_first_name',
                'contact_author_PI_first_name',             'TEXT'],
            ['contact_author_PI_last_name',
                'contact_author_PI_last_name',              'TEXT'],
            ['contact_author_PI_middle_name',
                'contact_author_PI_middle_name',            'TEXT'],
            ['contact_author_PI_role',
                'contact_author_PI_role',                   'TEXT'],
            ['contact_author_PI_organization_type',
                'contact_author_PI_organization_type',      'TEXT'],
            ['contact_author_PI_organization_name',
                'contact_author_PI_organization_name',      'TEXT'],
            ['contact_author_PI_email',
                'contact_author_PI_email',                  'TEXT'],
            ['contact_author_PI_address',
                'contact_author_PI_address',                'TEXT'],
            ['contact_author_PI_city',
                'contact_author_PI_city',                   'TEXT'],
            ['contact_author_PI_State_or_Province',
                'contact_author_PI_State_or_Province',      'TEXT'],
            ['contact_author_PI_Zip_Code',
                'contact_author_PI_Zip_Code',               'TEXT'],
            ['contact_author_PI_Country',
                'contact_author_PI_Country',                'TEXT'],
            ['contact_author_PI_fax_number',
                'contact_author_PI_fax_number',             'TEXT'],
            ['contact_author_PI_phone_number',
                'contact_author_PI_phone_number',           'TEXT'],
            ['contact_author_PI_ORCID',
                'contact_author_PI_ORCID',                  'TEXT'],

            ['contact_author_salutation',
                'contact_author_salutation',                'TEXT'],
            ['contact_author_first_name',
                'contact_author_first_name',                'TEXT'],
            ['contact_author_last_name',
                'contact_author_last_name',                 'TEXT'],
            ['contact_author_middle_name',
                'contact_author_middle_name',               'TEXT'],
            ['contact_author_role',
                'contact_author_role',                      'TEXT'],
            ['contact_author_organization_type',
                'contact_author_organization_type',         'TEXT'],
            ['contact_author_organization_name',
                'contact_author_organization_name',         'TEXT'],
            ['contact_author_email',
                'contact_author_email',                     'TEXT'],
            ['contact_author_address',
                'contact_author_address',                   'TEXT'],
            ['contact_author_city',
                'contact_author_city',                      'TEXT'],
            ['contact_author_State_or_Province',
                'contact_author_State_or_Province',         'TEXT'],
            ['contact_author_Zip_Code',
                'contact_author_Zip_Code',                  'TEXT'],
            ['contact_author_Country',
                'contact_author_Country',                   'TEXT'],
            ['contact_author_fax_number',
                'contact_author_fax_number',                'TEXT'],
            ['contact_author_phone_number',
                'contact_author_phone_number',              'TEXT'],
            ['contact_author_ORCID',
                'contact_author_ORCID',                     'TEXT'],

            ['Release_status_for_coordinates',
                'Release_status_for_coordinates',           'TEXT'],
            ['Release_status_for_structure_factor',
                'Release_status_for_structure_factor',      'TEXT'],
            ['Release_status_for_sequence',
                'Release_status_for_sequence',              'TEXT'],

            ['group_deposition_title',
                'group_deposition_title',                   'TEXT'],
            ['group_description',
            ...
            ['group_deposition_title_apo',
                'group_deposition_title_apo',               'TEXT'],
            ['structure_title_apo',
                'structure_title_apo',                      'TEXT'],

            ['structure_author_name',
                'structure_author_name',                    'TEXT'],
            ['primary_citation_author_name',
                'primary_citation_author_name',             'TEXT'],

            ['primary_citation_id',
                'primary_citation_id',                      'TEXT'],
            ['primary_citation_journal_abbrev',
                'primary_citation_journal_abbrev',          'TEXT'],
            ['primary_citation_title',
                'primary_citation_title',                   'TEXT'],
            ['primary_citation_year',
                'primary_citation_year',                    'TEXT'],
            ['primary_citation_journal_volume',
                'primary_citation_journal_volume',          'TEXT'],
            ['primary_citation_page_first',
                'primary_citation_page_first',              'TEXT'],
            ['primary_citation_page_last',
                'primary_citation_page_last',               'TEXT'],
            ...
            ['Fragment_name',
                'Fragment_name',                            'TEXT'],
            ['Specific_mutation',
                'Specific_mutation',                        'TEXT'],
            ['Enzyme_Comission_number',
                'Enzyme_Comission_number',                  'TEXT'],
            ['Source_organism_scientific_name',
                'Source_organism_scientific_name',          'TEXT'],
            ['Source_organism_gene',
                'Source_organism_gene',                     'TEXT'],
            ['Source_organism_strain',
                'Source_organism_strain',                   'TEXT'],
            ['Expression_system_scientific_name',
                'Expression_system_scientific_name',        'TEXT'],
            ['Expression_system_strain',
                'Expression_system_strain',                 'TEXT'],
            ['Expression_system_vector_type',
                'Expression_system_vector_type',            'TEXT'],
            ['Expression_system_plasmid_name',
                'Expression_system_plasmid_name',           'TEXT'],
            ['Manipulated_source_details',
                'Manipulated_source_details',               'TEXT'],
            ['fragment_name_one_specific_mutation',
                'fragment_name_one_specific_mutation',      'TEXT'],
            ['molecule_chain_one',
                'molecule_chain_one',                       'TEXT'],

            ['molecule_name_two',
                'molecule_name_two',                        'TEXT'],
            ['Fragment_name_two',
                'Fragment_name_two',                        'TEXT'],
            ['Specific_mutation_two',
                'Specific_mutation_two',                    'TEXT'],
            ['Enzyme_Comission_number_two',
                'Enzyme_Comission_number_two',              'TEXT'],
            ['Source_organism_scientific_name_two',
                'Source_organism_scientific_name_two',      'TEXT'],
            ['Source_organism_gene_two',
                'Source_organism_gene_two',                 'TEXT'],
            ['Source_organism_strain_two',
                'Source_organism_strain_two',               'TEXT'],
            ['Expression_system_scientific_name_two',
                'Expression_system_scientific_name_two',    'TEXT'],
            ['Expression_system_strain_two',
                'Expression_system_strain_two',             'TEXT'],
            ['Expression_system_vector_type_two',
                'Expression_system_vector_type_two',        'TEXT'],
            ['Expression_system_plasmid_name_two',
                'Expression_system_plasmid_name_two',       'TEXT'],
            ['Manipulated_source_details_two',
                'Manipulated_source_details_two',           'TEXT'],
            ['fragment_name_two_specific_mutation',
                'fragment_name_one_specific_mutation_two',  'TEXT'],
            ['molecule_chain_two',
                'molecule_chain_two',                       'TEXT'],

            ['structure_keywords',
                'structure_keywords',                       'TEXT'],
            ['biological_assembly_chain_number',
                'biological_assembly_chain_number',         'TEXT'],
            ...
            ['crystallization_pH',
                'crystallization_pH',                       'TEXT'],
            ['crystallization_temperature',
                'crystallization_temperature',              'TEXT'],
            ['crystallization_details',
                'crystallization_details',                  'TEXT'],

            ['radiation_source',
                'radiation_source',                         'TEXT'],
            ['radiation_source_type',
                'radiation_source_type',                    'TEXT'],
            ['radiation_wavelengths',
                'radiation_wavelengths',                    'TEXT'],
            ['radiation_detector',
                'radiation_detector',                       'TEXT'],
            ['radiation_detector_type',
                'radiation_detector_type',                  'TEXT'],
            ['data_collection_date',
                'data_collection_date',                     'TEXT'],
            ['data_collection_temperature',
                'data_collection_temperature',              'TEXT'],
            ['data_collection_protocol',
                'data_collection_protocol',                 'TEXT'],

            ['SG_project_name',
                'SG_project_name',                          'TEXT'],
            ['full_name_of_SG_center',
                'full_name_of_SG_center',                   'TEXT'],

            ['molecule_one_letter_sequence',
                'molecule_one_letter_sequence',             'TEXT'],
            ['molecule_one_letter_sequence_uniprot_id',
                'molecule_one_letter_sequence_uniprot_id',  'TEXT'],
            ['molecule_two_letter_sequence',
                'molecule_two_letter_sequence',             'TEXT'],
            ['molecule_two_letter_sequence_uniprot_id',
                'molecule_two_letter_sequence_uniprot_id',  'TEXT'],

            ['CrystalName_of_pandda_input',
                'CrystalName_of_pandda_input',              'TEXT'],

            ['pdbx_starting_model',
                'pdbx_starting_model',                      'TEXT'],
            ['data_integration_software',
                'data_integration_software',                'TEXT'],
            ['phasing_software',
                'phasing_software',                         'TEXT'],

            ['pdbx_funding_ordinal_one',
                'pdbx_funding_ordinal_one',                 'TEXT'],
            ['pdbx_funding_organization_one',
                'pdbx_funding_organization_one',            'TEXT'],
            ['pdbx_grant_number_one',
                'pdbx_grant_number_one',                    'TEXT'],
            ['pdbx_grant_country_one',
                'pdbx_grant_country_one',                   'TEXT'],

            ['pdbx_funding_ordinal_two',
                'pdbx_funding_ordinal_two',                 'TEXT'],
            ['pdbx_funding_organization_two',
                'pdbx_funding_organization_two',            'TEXT'],
            ['pdbx_grant_number_two',
                'pdbx_grant_number_two',                    'TEXT'],
            ['pdbx_grant_country_two',
                'pdbx_grant_country_two',                   'TEXT'],

            ['pdbx_funding_ordinal_three',
                'pdbx_funding_ordinal_three',               'TEXT'],
            ['pdbx_funding_organization_three',
                'pdbx_funding_organization_three',          'TEXT'],
            ['pdbx_grant_number_three',
                'pdbx_grant_number_three',                  'TEXT'],
            ['pdbx_grant_country_three',
                'pdbx_grant_country_three',                 'TEXT'],
        ...
        self.data_collection_columns = [
            ...
            ['DataCollectionCrystalImage1',             'img1',
                'TEXT',                 1],
            ['DataCollectionCrystalImage2',             'img2',
                'TEXT',                 1],
            ['DataCollectionCrystalImage3',             'img3',
                'TEXT',                 1],
            ['DataCollectionCrystalImage4',             'img4',
                'TEXT',                 1],
        ...
        for table in tableDict:
            ...
            for column in tableDict[table]:
                if column[0] not in existing_columns:
                    cursor.execute(
                        "alter table " + table + " add column '" + column[0] + "' '" + column[2] + "'")
                    connect.commit()
            if table == 'labelTable':
...
#                connect.commit()
    ...
    def create_empty_data_source_file(self):
        ...
        with connect:
            cursor = connect.cursor()
            cursor.execute(
                "CREATE TABLE mainTable("+self.column_list[0][0]+' '+self.column_list[0][2]+")")
            for i in range(1, len(self.column_list)):
                cursor.execute("alter table mainTable add column '" +
                               self.column_list[i][0]+"' '"+self.column_list[i][2]+"'")
            connect.commit()
...
#            cursor.execute("select * from depositTable where CrystalName='{0!s}';".format(sampleID))
    ...
    def get_zenodo_dict_for_pandda_analysis(self, panddaPath):
        ...
        try:
            cursor.execute(
                "select * from zenodoTable where DimplePANDDApath='{0!s}';".format(panddaPath))
            for column in cursor.description:
                header.append(column[0])
            data = cursor.fetchall()
            try:
    ...
    def get_db_pandda_dict_for_sample_and_site(self, sampleID, site_index):
        ...
        cursor = connect.cursor()
        cursor.execute(
            "select * from panddaTable where CrystalName='{0!s}' and PANDDA_site_index='{1!s}';".format(sampleID, site_index))
        for column in cursor.description:
            header.append(column[0])
        data = cursor.fetchall()
        for n, item in enumerate(data[0]):
    ...
    def get_db_pandda_dict_for_sample_and_site_and_event(self, sampleID, site_index, event_index):
        ...
        connect = sqlite3.connect(self.data_source_file)
        cursor = connect.cursor()
        cursor.execute("select * from panddaTable where CrystalName='{0!s}' and PANDDA_site_index='{1!s}' and PANDDA_site_event_index='{2!s}' and PANDDA_site_ligand_placed='True';".format(
...
#                        print "UPDATE mainTable SET "+update_string[:-1]+" WHERE CrystalName="+"'"+sampleID+"';"
                        cursor.execute(
                            "UPDATE mainTable SET "+update_string[:-1]+" WHERE CrystalName="+"'"+sampleID+"';")
                else:
                    column_string = ''
                    value_string = ''
                    for key, value in line.iteritems():
...
#                    print          "INSERT INTO mainTable ("+column_string[:-1]+") VALUES ("+value_string[:-1]+");"
                    cursor.execute(
                        "INSERT INTO mainTable ("+column_string[:-1]+") VALUES ("+value_string[:-1]+");")
    ...
    def update_data_source(self, sampleID, data_dict):
        ...
        if update_string != '':
            #            print "UPDATE mainTable SET "+update_string[:-1]+" WHERE CrystalName="+"'"+sampleID+"'"
            cursor.execute("UPDATE mainTable SET " +
                           update_string[:-1]+" WHERE CrystalName="+"'"+sampleID+"'")
            connect.commit()
    ...
    def update_panddaTable(self, sampleID, site_index, data_dict):
        ...
        for key in data_dict:
            ...
            if not str(value).replace(' ', '') == '':  # ignore empty fields
                ...
                update_string += str(key)+' = null,'
        if update_string != '':
            cursor.execute("UPDATE panddaTable SET " +
                           update_string[:-1]+" WHERE CrystalName='{0!s}' and PANDDA_site_index='{1!s}'".format(sampleID, site_index))
            connect.commit()
    ...
    def update_site_event_panddaTable(self, sampleID, site_index, event_index, data_dict):
        ...
        if update_string != '':
            cursor.execute("UPDATE panddaTable SET " +
                           update_string[:-1]+" WHERE CrystalName='{0!s}' and PANDDA_site_index='{1!s}' and PANDDA_site_event_index='{2!s}'".format(sampleID, site_index, event_index))
            connect.commit()
    ...
    def update_depositTable(self, sampleID, structure_type, data_dict):
        ...
        if update_string != '':
            ...
            cursor.execute('UPDATE depositTable SET ' +
                           update_string[:-1]+' WHERE CrystalName="{0!s}" and StructureType="{1!s}"'.format(sampleID, structure_type))
            connect.commit()
    ...
    def update_insert_data_source(self, sampleID, data_dict):
        ...
        if self.check_if_sample_exists_in_data_source(sampleID):
            for key in data_dict:
                ...
                if not str(value).replace(' ', '') == '':  # ignore empty fields
                    update_string = str(key)+'='+"'"+str(value)+"'"
                    cursor.execute("UPDATE mainTable SET "+update_string +
...
#                    print "UPDATE panddaTable SET "+update_string+" WHERE CrystalName="+"'"+sampleID+"' and PANDDA_site_index is '"+data_dict['PANDDA_site_index']+"';"
                    cursor.execute("UPDATE panddaTable SET "+update_string+" WHERE CrystalName=" +
                                   "'"+sampleID+"' and PANDDA_site_index is '"+data_dict['PANDDA_site_index']+"';")
        else:
            column_string = ''
            value_string = ''
            for key in data_dict:
...
#                    continue
    ...
    def update_insert_any_table(self, table, data_dict, condition_dict):
        ...
        for key in condition_dict:
            ...
            condition_string += str(key) + '=' + "'" + \
                str(condition) + "' and "

        cursor.execute('Select %s FROM %s where %s' %
                       (columns[:-1], table, condition_string[:-5]))
        ...
        if found_sample_site:
            for key in data_dict:
                ...
                if not str(value).replace(' ', '') == '':  # ignore empty fields
                    update_string = str(key)+'='+"'"+str(value)+"'"
#                    print "UPDATE panddaTable SET "+update_string+" WHERE CrystalName="+"'"+sampleID+"' and PANDDA_site_index is '"+data_dict['PANDDA_site_index']+"';"
                    cursor.execute("UPDATE panddaTable SET "+update_string+" WHERE CrystalName="+"'"+sampleID+"' and PANDDA_site_index is '" +
                                   data_dict['PANDDA_site_index']+"' and PANDDA_site_event_index is '"+data_dict['PANDDA_site_event_index']+"';")
        else:
            column_string = ''
            value_string = ''
            for key in data_dict:
...
#                    cursor.execute("UPDATE mainTable SET "+update_string+" WHERE CrystalName="+"'"+sampleID+"' and "+str(key)+" is null;")
                    cursor.execute("UPDATE mainTable SET "+update_string+" WHERE CrystalName=" +
                                   "'"+sampleID+"' and ("+str(key)+" is null or "+str(key)+"='');")
        else:
            column_string = 'CrystalName'+','
            value_string = "'"+sampleID+"'"+','
            for key in data_dict:
    ...
    def get_value_from_field(self, sampleID, column):
        ...
        cursor.execute("SELECT "+column +
                       " FROM  mainTable WHERE CrystalName='"+sampleID+"';")
    ...
    def get_todo_list_for_coot(self, RefinementOutcome, pandda_site):
        ...
        if int(pandda_site) > 0:
            ...
            sqlite = (
                ...
                "where panddaTable.PANDDA_site_index is '%s'" % pandda_site +
                " and panddaTable.PANDDA_site_ligand_placed is 'True'"
                " and panddaTable.RefinementOutcome like " +
                outcome.split()[0]+"%';"
            )
#            sqlite = (
#                "select"
...
#        print str(tmp)
        ...
        if not apoStructureList:
            Logfile.insert(
                'no apo structures were assigned to your pandda models')
        else:
            Logfile.insert(
                'the following datasets were at some point used as apo structures for pandda.analyse: '+str(apoStructureList))
            apoInDB = []
            cursor.execute(
        ...
        for files in glob.glob(os.path.join(projectDir, '*')):
            ...
            if xtal not in apoStructureList:
                ...
                if dimple_mtz == False or dimple_pdb == False or aimless_log == False:
                    Logfile.insert('{0!s}: missing files -> dimple.pdb: {1!s}, dimple.mtz: {2!s}, {3!s}.log: {4!s}'.format(
                        xtal, str(dimple_pdb), str(dimple_mtz), xtal, str(aimless_log)))
                else:
                    newEntries += "('{0!s}','apo'),".format(xtal)
                    counter += 1
...
#    def get_deposit_dict_for_xtal(self,sampleID,structure_type):
    ...
    def create_or_remove_missing_records_in_depositTable(self, xce_logfile, xtal, type, db_dict):
        ...
        if type == 'ligand_bound':
            cursor.execute(
                "select RefinementOutcome from mainTable where CrystalName is '{0!s}'".format(xtal))
            tmp = cursor.fetchall()
            oldRefiStage = str(tmp[0][0])
            Logfile.insert('setting RefinementOutcome field to "' +
                           db_dict['RefinementOutcome']+'" for '+xtal)
            self.update_insert_data_source(xtal, db_dict)
        elif type == 'ground_state':
            cursor.execute("select DimplePANDDApath from depositTable where StructureType is '{0!s}' and DimplePANDDApath is '{1!s}'".format(
            ...
            if not tmp:
                ...
                cursor.execute("update depositTable set PDB_file='%s', MTZ_file='%s', DimplePANDDApath='%s' where StructureType='ground_state'" % (
                    db_dict['PDB_file'], db_dict['MTZ_file'], db_dict['DimplePANDDApath']))
                connect.commit()
                return

        cursor.execute(
            "select CrystalName,StructureType from depositTable where CrystalName is '{0!s}' and StructureType is '{1!s}'".format(xtal, type))
        tmp = cursor.fetchall()
        if type == 'ligand_bound':
            if not tmp and int(db_dict['RefinementOutcome'].split()[0]) == 5:
                sqlite = "insert into depositTable (CrystalName,StructureType) values ('{0!s}','{1!s}');".format(
                    xtal, type)
                Logfile.insert('creating new entry for '+str(type) +
                               ' structure of '+xtal+' in depositTable')
                cursor.execute(sqlite)
                connect.commit()
            else:
                if int(db_dict['RefinementOutcome'].split()[0]) != 5:
                    ...
                    if oldRefiStage.startswith('5'):
                        Logfile.insert(
                            'removing entry for '+str(type)+' structure of '+xtal+' from depositTable')
                    cursor.execute(sqlite)
                    connect.commit()
        elif type == 'ground_state':
            sqlite = "insert into depositTable (CrystalName,StructureType,DimplePANDDApath,PDB_file,MTZ_file) values ('{0!s}','{1!s}','{2!s}','{3!s}','{4!s}');".format(
                xtal, type, db_dict['DimplePANDDApath'], db_dict['PDB_file'], db_dict['MTZ_file'])
            Logfile.insert('creating new entry for ' + str(type) +
                           ' structure of ' + xtal + ' in depositTable')
            cursor.execute(sqlite)
            connect.commit()
    ...
    def remove_selected_apo_structures_from_depositTable(self, xce_logfile, xtalList):
        ...
        Logfile.insert(
            'removing the following apo structures from depositTable')
        deleteStrg = "("
        ...
        sqlite = "delete from depositTable where {0!s} and StructureType is 'apo'".format(
            deleteStrg)
...
#
    ...
    def collected_xtals_during_visit(self, visitID):
        ...
        cursor = connect.cursor()
        cursor.execute(
            "select CrystalName from collectionTable where DataCollectionVisit = '{0!s}'".format(visitID))
        collectedXtals = []
        samples = cursor.fetchall()
        for sample in samples:
...
#            cursor.execute("select CrystalName from mainTable where DataProcessingAutoAssigned = 'True' and DataCollectionVisit = '%s'" %visit)
        cursor.execute(
            "select distinct CrystalName from collectionTable where DataCollectionVisit = '%s'" % visit)
        samples = cursor.fetchall()
        for sample in samples:
    ...
    def autoprocessing_result_user_assigned(self, sample):
        ...
        cursor = connect.cursor()
        cursor.execute(
            "select DataProcessingAutoAssigned from mainTable where CrystalName = '%s'" % sample)
...
#            print sq
            for s in sq:
                #                print s
                t = [str(s[0]), str(s[1]), str(s[2]), str(s[3]), str(s[4]), str(
                    s[5]), str(s[6]), str(s[7]), str(s[8]), str(s[9])]
                inDict = False
    ...
    def getCrystalImageDict(self, visit, xtalList):
        ...
        for xtal in xtalList:
            ...
            cursor.execute(sqlite)
            img = cursor.fetchall()
            imageDict[xtal] = [str(img[1]), str(
                img[2]), str(img[3]), str(img[4])]
        return imageDict
    ...
    def get_label_of_sample(self, xtalID):
        ...
        cursor = connect.cursor()
        cursor.execute(
            "select label from mainTable where CrystalName is '%s'" % xtalID)
        label = None
        lab = cursor.fetchall()
        for l in lab:
            label = l[0]
