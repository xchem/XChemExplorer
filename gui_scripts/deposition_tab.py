...
class DepositionTab():
    ...
    def setup(self, xce_object):
        ...
        deposition_bound_state_preparation_step_one_text = self.layout_funcs.add_depo_text(
            XChemToolTips.deposition_bound_state_preparation_step_one_text())

        xce_object.deposition_bounnd_state_preparation_ignore_event_map = QtGui.QCheckBox(
        ...
        deposition_bound_state_preparation_step_two_text = self.layout_funcs.add_depo_text(
        ...
        deposition_ground_state_preparation_step_one_text = self.layout_funcs.add_depo_text(
...
#        xce_object.ground_state_mtz_button_label.setStyleSheet('color: blue')
        ...
        deposition_ground_state_preparation_step_three_text = self.layout_funcs.add_depo_text(
        ...
        xce_object.ground_state_pandda_directory_label.setStyleSheet(
            'color: blue')

        deposition_ground_state_preparation_step_four_text = self.layout_funcs.add_depo_text(
        ...
        add_ground_state_db_button.clicked.connect(
            xce_object.add_ground_state_db)
        add_ground_state_db_button.setMaximumWidth(200)

        deposition_ground_state_preparation_step_five_text = self.layout_funcs.add_depo_text(
            XChemToolTips.deposition_ground_state_preparation_step_five_text())

        deposition_ground_state_preparation_step_six_text = self.layout_funcs.add_depo_text(
        ...
        deposition_ground_state_preparation_step_seven_text = self.layout_funcs.add_depo_text(
        ...
        deposition_ground_state_preparation_step_eight_text = self.layout_funcs.add_depo_text(
        ...
        after_deposition_preparation = self.layout_funcs.add_depo_heading(
            'Procedure')
        after_deposition_preparation.setStyleSheet(
            "font: italic bold 17pt Arial ")
